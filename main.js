...
const opponent = [chalk.magenta("Zombie"), chalk.blue("Skeleton"), chalk.magenta("Monster"), chalk.blue("Assasin"), chalk.magenta("Wizard")];
...
let condition = true;
class game {
    constructor(userName, enemyHP, userHP) {
        this.enemyName = selection.userChoice;
...
let actions = [chalk.magenta("Attack"), chalk.blue("Defense"), chalk.magenta("Heal Yourself")];
while (condition) {
